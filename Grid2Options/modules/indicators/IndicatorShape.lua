...
function Grid2Options:MakeIndicatorShapeCustomOptions(indicator, options)
	...
	options.shapeType = {
		...
		get = function(info)
			return indicator.dbx.iconIndex or 0
		end,
		set = function(info, v)
	...
	options.shapeRotation = {
		...
		get = function(info)
			return indicator.dbx.iconRotation or 0
		end,
		set = function(info, v)
	...
	options.shadowEnabled = {
		...
		tristate = false,
		get = function()
			return indicator.dbx.shadowEnabled
		end,
		set = function(_, v)
	...
	options.shadowSize = {
		...
		step = 1,
		get = function()
			return indicator.dbx.shadowSize or 0
		end,
		set = function(_, v)
		...
		hidden = function()
			return indicator.dbx.shadowEnabled == nil
		end
	}
	options.shadowX = {
		type = "range",
		...
		bigStep = 1,
		get = function()
			return indicator.dbx.shadowX or 0
		end,
		set = function(_, v)
	...
	options.shadowColor = {
		...
		desc = L["Color"],
		get = function()
			return self:UnpackColor(indicator.dbx.shadowColor, "BLACK")
		end,
