...
L["Type a name or spell identifier to add to the list below."] = true
L["If available use the spell identifier instead of the spell name to detect the auras."] = true
...
-- Keys ported from Grid2 2.9.31-bcc (3.3.5-compatible options)
L["Activation"] = true
L["Additional Themes"] = true
L["Additive"] = true
L["Adjust the background texture."] = true
L["Adjust the size of the icons."] = true
L["Adjust the texture of the indicator."] = true
L["Always active"] = true
...
L["Blacklist"] = true
L["Bosses"] = true
L["Check this option to specify a list of players names to display."] = true
...
L["Display only debuffs contained in a user defined list."] = true
L["Display the status only when all buffs are active."] = true
L["Displays an invisible Icon."] = true
L["Do not display the player frame (only applied when in party)."] = true
L["Enable Theme for:"] = true
L["Glow Border: Blizzard"] = true
L["Glow Border: Pixel"] = true
L["Glow Border: Shine"] = true
L["HealComm Time Frame"] = true
L["Hide Player"] = true
L["Highlight"] = true
L["Highlight Effect"] = true
L["Ignore debuffs contained in a user defined list. This condition is always strict."] = true
L["LEFTBOTTOM"] = true
L["LEFTTOP"] = true
L["Link to Chat"] = true
L["List"] = true
...
L["Unit is Me"] = true
L["Load the status only if the unit is my character."] = true
L["Indicators"] = true
L["In Combat"] = true
...
L["On Status Activation"] = true
L["On Status Updates"] = true
...
L["Players"] = true
L["Player Class"] = true
L["Load the indicator only if your toon belong to the specified class."] = true
L["Primary"] = true
L["RIGHTBOTTOM"] = true
L["RIGHTTOP"] = true
L["Rename"] = true
...
L["This indicator cannot be highlighted because is disabled for the current theme or layout."] = true
L["Rename Theme:"] = true
...
L["Select the Highlight effect."] = true
L["Select the condition that must be met to display a new theme."] = true
L["Select when to activate the highlight effect."] = true
L["Select when to start the Zoom In effect"] = true
L["Sets the background color to use when no status is active."] = true
L["Sets the glow color to display when the indicator is highlighted."] = true
L["Shadow"] = true
L["Shape"] = true
...
L["There are status linked to this indicator."] = true
L["This indicator cannot be changed from here: go to indicators section to assign/unassign statuses to this indicator."] = true
L["This indicator cannot be renamed because is anchored to another indicator."] = true
...
L["Use strict filtering (all conditions must be met)."] = true
L["Whitelist"] = true
...
L["Remaining seconds"] = true
L["Select the minimum number of aura stacks to activate the status."] = true
L["Select when to highlight the status. Linked indicators must have a hightlight effect configured."] = true
L["Single Color"] = true
L["Stacks"] = true
L["Text to Display"] = true
L["Text to display in Text Indicators."] = true
L["Threshold in remaining seconds at which to highlight the status. The status will blink or glow depending of the linked indicator configuration."] = true
L["Type Custom Text"] = true
L["Type Max Duration"] = true
L["Type the maximum duration for the aura in seconds."] = true
L["Unknown"] = true
L["Value"] = true
L["Value1"] = true
L["Value2"] = true
