...
-- L["Icon"] = ""
-- L["Max Icons"] = ""
L["Display Squares"] = "Показывать квадраты"
L["Display flat square textures instead of the icons provided by the statuses."] = "Показывать плоские квадратные текстуры вместо иконок, предоставляемых статусами."
-- L["Icons per row"] = ""
-- L["Icon Size"] = ""
-- L["Icon Spacing"] = ""
-- L["Direction"] = ""
...
L["Show relevant buffs for each unit frame (the same buffs displayed by the Blizzard raid frames)."] = "Показывать подходящие баффы на каждом фрейме (те же баффы, что на стандартных рейд-фреймах Blizzard)."
...
L["Type a name or spell identifier to add to the list below."] = "Введи имя или идентификатор заклинания, чтобы добавить в список ниже."
L["If available use the spell identifier instead of the spell name to detect the auras."] = "Если доступно, использовать ID заклинания вместо имени для отслеживания аур."
...
L["Highlight Indicator"] = "Подсветить Индикатор"
L["indicator"] = "индикатор"
L["This indicator cannot be deleted because is in use. Uncheck the statuses linked to the indicator first."] = "Этот индикатор нельзя удалить, потому что он используется. Сначала отвяжите привязанные к нему статусы."
L["This indicator cannot be highlighted because is disabled for the current theme or layout."] = "Этот индикатор нельзя подсветить, потому что он отключен для текущей темы или раскладки."
L["Reverse"] = "Обратить"
...
L["Load the indicator only if your toon belong to the specified class."] = "Загружать индикатор только если ваш персонаж принадлежит указанному классу."
L["Group Type"] = "Тип группы"
L["Load the status only if you are in the specified group type."] = "Загружать статус только если вы находитесь в указанном типе группы."
L["Solo"] = "Соло"
L["Party"] = "Группа"
L["Arena"] = "Арена"
L["Raid 10"] = "Рейд 10"
...
L["Raid 25"] = "Рейд 25"
L["Raid 40"] = "Рейд 40"
L["Instance Name/ID"] = "Имя/ID подземелья"
L["Supports multiple names or IDs separated by commas or newlines.\n\nCurrent Instance:\n%s(%d)"] = "Поддерживаются несколько имён или ID через запятую или новую строку.\n\nТекущее подземелье:\n%s(%d)"
L["Spell Ready"] = "Заклинание готово"
L["Load the status only if the specified player spell is not in cooldown."] = "Загружать статус только если указанное заклинание игрока не на перезарядке."
L["Unit Alive"] = "Юнит жив"
L["Load the status only if the unit is alive/dead."] = "Загружать статус только если юнит жив/мёртв."
L["Unit Reaction"] = "Реакция юнита"
L["Load the status only if the unit has the specified reaction towards the player."] = "Загружать статус только если у юнита указанная реакция по отношению к игроку."
L["Friendly"] = "Дружелюбный"
L["Hostile"] = "Враждебный"
L["Unit Class"] = "Класс юнита"
L["Load the status only if the unit belong to the specified class."] = "Загружать статус только если юнит принадлежит указанному классу."
L["Unit Role"] = "Роль юнита"
L["Load the status only if the unit has the specified role."] = "Загружать статус только если у юнита указанная роль."
L["Tank"] = "Танк"
L["Healer"] = "Лекарь"
L["Damager"] = "Боец"
L["Unit Type"] = "Тип юнита"
L["Load the status only for the specified unit types."] = "Загружать статус только для указанных типов юнитов."
L["Pets"] = "Питомцы"
L["Focus"] = "Фокус"
L["Unit is Me"] = "Юнит — это я"
L["Load the status only if the unit is my character."] = "Загружать статус только если юнит — мой персонаж."
...
L["Allowed debuffs"] = "Разрешённые дебаффы"
L["Combine Stacks"] = "Суммировать стаки"
L["Display the status only when all buffs are active."] = "Показывать статус, только когда активны все баффы."
L["Hide on pets"] = "Скрывать на питомцах"
L["Highlight"] = "Подсветка"
L["Max Duration"] = "Макс. длительность"
L["Multiple instances of the same debuff will be treated as multiple stacks of the same debuff."] = "Несколько копий одного дебаффа считаются стаками одного дебаффа."
L["Never display this status on pets."] = "Никогда не показывать этот статус на питомцах."
L["Remaining seconds"] = "Оставшиеся секунды"
L["Select when to highlight the status. Linked indicators must have a hightlight effect configured."] = "Когда подсвечивать статус. У связанных индикаторов должен быть настроен эффект подсветки."
L["Show when all buffs are active"] = "Показывать, когда активны все баффы"
L["Stacks"] = "Стаки"
L["Text to Display"] = "Отображаемый текст"
L["Text to display in Text Indicators."] = "Текст для текстовых индикаторов."
L["Threshold in remaining seconds at which to highlight the status. The status will blink or glow depending of the linked indicator configuration."] = "Порог в оставшихся секундах для подсветки статуса. Статус будет мигать или светиться в зависимости от настроек связанного индикатора."
L["Type Custom Text"] = "Свой текст"
L["Type Max Duration"] = "Макс. длительность"
L["Type the maximum duration for the aura in seconds."] = "Максимальная длительность ауры в секундах."
L["Unknown"] = "Неизвестно"
L["Display only debuffs contained in a user defined list."] = "Показывать только дебаффы из списка."
L["Ignore debuffs contained in a user defined list. This condition is always strict."] = "Игнорировать дебаффы из списка. Условие всегда строгое."
L["Use strict filtering (all conditions must be met)."] = "Строгая фильтрация (все условия должны выполняться)."
L["Type a list of debuffs, one debuff per line."] = "Список дебаффов, по одному на строку."
