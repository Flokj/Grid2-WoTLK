-- Classic default database values for the 3.3.5 (WotLK) client.
-- Mirrors the BCC GridDefaultsClassic.lua structure (Grid2:MakeDefaultsCommon()
-- and per-class Grid2.MakeDefaultsClass()), but spell IDs and indicators match
-- this client: WotLK spell ranks and no MONK section (no monks on 3.3.5).
-- Wired in GridDefaults.lua UpdateDefaults(), loaded after GridDefaults.lua.
